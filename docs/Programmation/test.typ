...
#figure(
  image("data/turing16.png", width: 40%),
)
...
#figure(
  image("data/turing.png", width: 80%),
)
...
#figure(
  image("data/louapre.png", width: 30%),
)
