...
\begin{frame}
	...
	\begin{block}{Programmation procédurale}
		...
		\end{itemize}
		\onslide<4->{En informatique, une façon de d'approcher un problème et d'en concevoir et  modéliser une solution s'appelle un \textcolor{red}{paradigme} de programmation, et nous n'avons donc jusqu'à maintnenant utilisé le \textcolor{blue}{paradigme procédural}.}
	\end{block}
\end{frame}
