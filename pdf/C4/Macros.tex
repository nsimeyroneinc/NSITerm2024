...
\cfoot{}}
\newcommand{\Devoir}[2]{\lhead{\textbf{Devoir : {\sc #1}}}
...
\newcommand{\TPNSI}[2]{\lhead{\textbf{TP à rendre de {\sc nsi} : \textsf{ #1}}
	}
	\rhead{\textbf{#2}} \setlength{\fboxsep}{8pt}
	\cfoot{}
	\begin{center}{\Large \textbf{TP évalué de {\sc nsi}}}\end{center}}

\newcommand{\ProjetNSI}[3]{\lhead{\textbf{Mini-projet à rendre de {\sc nsi} : \textsf{ #1}}
	}
	\rhead{\textbf{#2}} \setlength{\fboxsep}{8pt}
	\cfoot{}
	\begin{center}{\Large \textbf{Mini-projet de {\sc nsi} : #3}}\end{center}
\vspace{0.5cm}}
